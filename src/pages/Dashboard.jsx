...
const Stat = ({
  ...
  >
    ...
    {sub && (
      <div style={{ fontSize: "0.72rem", color: T.muted, marginTop: 5 }}>
        {sub}
      </div>
    )}
  </motion.div>
      ...
      >
        <div
          style={{
            ...
            height: 500,
            borderRadius: "50%",
            background: `radial-gradient(circle, ${T.green}${
              dark ? "12" : "18"
            } 0%, transparent 65%)`,
          }}
        />
        <div
          style={{
            ...
            height: 400,
            borderRadius: "50%",
            background: `radial-gradient(circle, ${T.blue}${
              dark ? "10" : "14"
            } 0%, transparent 65%)`,
          }}
        />
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ color: T.muted, fontSize: "0.8rem", marginTop: 5 }}>
              {isSeller
                ? "🌾 Seller · Farmora Marketplace"
                : "🛒 Buyer · Farmora Marketplace"}
            </p>
          </div>
          <div
            style={{
              ...
              alignItems: "center",
              gap: 8,
              background: (isSeller ? T.green : T.blue) + "15",
              border: `1px solid ${isSeller ? T.green : T.blue}30`,
              borderRadius: 50,
              padding: "7px 16px",
            }}
          >
            <div
              style={{
                ...
                height: 7,
                borderRadius: "50%",
                background: isSeller ? T.green : T.blue,
                boxShadow: `0 0 8px ${isSeller ? T.green : T.blue}`,
              }}
            />
            <span
              style={{
                color: isSeller ? T.green : T.blue,
                fontSize: "0.72rem",
                fontWeight: 700,
                letterSpacing: "0.08em",
              }}
        ...
        {loading ? (
          ...
          <>
            ...
            >
              {statCards.map((s, i) => (
                <Stat key={s.label} {...s} delay={0.12 + i * 0.06} T={T} />
              ))}
            </div>

            {/* Charts */}
            <SectionLabel delay={0.35} T={T}>
              Analytics
            </SectionLabel>
            <div
              style={{
                ...
                >
                  <ResponsiveContainer width="100%" height={220}>
                    ...
                    >
                      ...
                      <Area
                        type="monotone"
                        dataKey={isSeller ? "revenue" : "spent"}
                        name={isSeller ? "Revenue (₹)" : "Spent (₹)"}
                        stroke={T.green}
                        strokeWidth={2}
                        fill="url(#gR)"
                      ...
                      <thead>
                        ...
                        >
                          {(isSeller
                            ...
                            : ["Product", "Qty", "Amount", "Status", "Date"]
                          ).map((h) => (
                            <th
                              key={h}
                              style={{
                      ...
                      <tbody>
                        {data.recentOrders.map((o, i) => (
                          ...
                          >
                            ...
                            <td style={{ padding: "11px 16px", color: T.text }}>
                              {o.product?.title || "—"}
                            </td>
                            <td
                              style={{ padding: "11px 16px", color: T.muted }}
                            >
                              {o.quantity}
                            </td>
                            <td
